...
!function (t) {
    var a, r, n = [];
    n.fr = {
        message: "Nous utilisons les cookies pour nos services. Pour utiliser ce site vous devez être d'accord avec cela",
        acceptText: "OK",
    ...
    var c = {
        init: function (o) {
            ...
            r = t.extend(e, o), "accepted" !== c.getCookie("cookies-state") && c.displayBar(), t(document).on("click", a + " .cookie-bar__btn", function (o) {
            ...
            }), t(document).on("click", ".cookie-bar-privacy-popup, .cookie-bar-privacy-popup__dialog__close", function (o) {
                c.hidePopup()
            }), t(document).on("click", ".cookie-bar-privacy-popup__dialog", function (o) {
                o.stopPropagation()
            })
        }, displayBar: function () {
            var o = '<button type="button" class="cookie-bar__btn">' + n[r.language].acceptText + "</button>",
                e = '<a href="' + r.infoLink + '" target="' + r.infoTarget + '" class="cookie-bar__link cookie-bar__link--cookies-info">' + n[r.language].infoText + "</a>",
                a = "";
            ...
            var i = '<div id="cookie-bar" class="cookie-bar cookie-bar--' + r.style + '"><div class="cookie-bar__inner"><span class="cookie-bar__message">' + n[r.language].message + '</span><span class="cookie-bar__buttons">' + o + e + a + "</span></div></div>";
            t(r.wrapper).prepend(i)
        }, hideBar: function () {
            t(a).slideUp()
        }, renderPopup: function () {
            var o = t('<div id="cookieBarPrivacyPopup" class="cookie-bar-privacy-popup cookie-bar-privacy-popup--hidden"><div class="cookie-bar-privacy-popup__dialog"><button type="button" class="cookie-bar-privacy-popup__dialog__close"></button></div></div>');
            t("body").append(o), t(".cookie-bar-privacy-popup__dialog", o).append(r.privacyContent)
        }, showPopup: function () {
            ...
            n[o] = e
        }, setCookie: function (o, e, a) {
            var i = new Date;
            i.setTime(i.getTime() + 24 * a * 60 * 60 * 1e3);
            var t = "expires=" + i.toUTCString();
            document.cookie = o + "=" + e + ";" + t + ";path=/"
        }, getCookie: function (o) {
            for (var e = o + "=", a = document.cookie.split(";"), i = 0; i < a.length; i++) {
